...
Hay muchos descriptores de características distintos, pero los que usa nuestro detector son conocidos como descriptores HOG. Estos cuentan las ocurrencias de orientaciones de gradiente en zonas localizadas de una imagen. El gradiente nos indica por cada pixel la magnitud del mayor cambio de intensidad posible y su dirección de oscuro a claro. VisuPodemos observar un ejemplo de esto en la Figura \ref{fig:hog01}.\\
