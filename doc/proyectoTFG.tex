...
Al clasificar el conjunto de test obtenemos un 54,29\% de precisión en el acierto lo que no supone ni un 1\% de mejora. La matriz de confusión de la Tabla \ref{tab:entrenamiento5MC}.
\begin{table}[h]
	\centering
	\small
	\setlength\tabcolsep{3pt}
