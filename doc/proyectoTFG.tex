...
El objetivo de este proyecto es simplificar dicho diagrama para que se asemeje al de la Figura \ref{fig:my_fer_diagram} de forma que no sea necesario extraer características de la imagen, y que sea más robusto con imágenes inclinadas o rotadas. Para lograr este objetivo y tras observar el auge que han tenido en la resolución de problemas de visión artificial, basaremos nuestra solución en el uso de Redes Neuronales Convolucionales.
\begin{figure}[h!]
\centering
