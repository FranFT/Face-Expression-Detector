...
\subsubsection{Caffe \cite{caffe}}
...
\subsubsection{NVIDIA Deep Learning GPU Training System \cite{digits}}
...
\subsubsection{Electron \cite{electron}}
...
\subsubsection{Base de datos: Karolinska Directed Emotional Faces (KDEF) \cite{kdef98}}
\begin{figure}[h]
	\centering
