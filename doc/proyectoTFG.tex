...
\subsection{Facial Expression Analysis using Active Shape Model\cite{shbib_zhou15}}
...
\subsection{Facial expression recognition and synthesis based on
	an appearance model\cite{abboud_davoine_dang04}}
...
\begin{thebibliography}{99}
	...
	\bibitem{pearson01}
	K. Pearson. %Names
	\textit{On Lines and Planes of Closest Fit to Systems of Points in Space}, %Title
	Philosophical Magazine. 2 (11): 559–572 %Location
	1901.	%Date
	
	\bibitem{abdi_williams10}
	H. Adbi, and L. Williams. %Names
	\textit{Principal component analysis}, %Title
	2010.	%Date
